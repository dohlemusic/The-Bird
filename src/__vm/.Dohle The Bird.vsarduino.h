/* 
	...
	Hardware: Generic STM32H7 Series                                                                                                     (STMicroelectronics_GenH7), Platform=stm32, Package=STMicroelectronics
*/
...
#define ARDUINO_DAISY_SEED 1
#define ARDUINO_ARCH_STM32 1
#define BOARD_NAME "DAISY_SEED"
#define VARIANT_H "variant_DAISY_SEED.h"
...
#include <arduino.h>
#include <variant_DAISY_PATCH_SM.h> 
#include <variant_DAISY_PETAL_SM.h> 
#include <variant_DAISY_SEED.h> 
#include <variant_generic.h> 
#include <variant_DAISY_PATCH_SM.cpp> 
#include <variant_DAISY_PETAL_SM.cpp> 
#include <variant_DAISY_SEED.cpp> 
#include <variant_generic.cpp> 
#undef cli
#define cli()
#include "TankVerbDaisy.ino"
#endif
#endif
